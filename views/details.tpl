...
<h2 class="card-title">Project List</h2>
      <ul class="list-group list-group-flush">
	  	<li class="list-group-item"><a href="https://www.ryancheley.com">RyanCheley.com</a> - My personal blog </li>
	  	<li class="list-group-item"><a href="https://www.interestingpeopledointerestingthings.com">Interesting People do Interesting Things</a>
